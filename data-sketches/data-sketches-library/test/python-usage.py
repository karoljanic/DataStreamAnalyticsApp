...
sketchNot2kNot3k_ptr = sketchNot2kNot3k.ctypes.data_as(ctypes.POINTER(ctypes.c_double))
...
updateSketch(sketchNot2kNot3k_ptr, SKETCH_SIZE, numbersNot2kNot3kDataStream, len(numbersNot2kNot3kDataStream), SEED)
...
print("cardinality of 2k or 3k numbers:", len(numbers2kOr3k), estimateDnfCardinality((ctypes.POINTER(ctypes.c_double) * 3)(sketch2k_ptr, sketch3k_ptr, sketch6k_ptr), 3, SKETCH_SIZE, (ctypes.POINTER(ctypes.c_ssize_t) * 2)((ctypes.c_ssize_t * 3)(1, -1, 0), (ctypes.c_ssize_t * 3)(-1, 1, 0)), 2))
print("cardinality of 2k and 3k numbers:", len(numbers2kAnd3k), estimateDnfCardinality((ctypes.POINTER(ctypes.c_double) * 3)(sketch6k_ptr, sketch3k_ptr, sketch2k_ptr), 3, SKETCH_SIZE, (ctypes.POINTER(ctypes.c_ssize_t) * 1)((ctypes.c_ssize_t * 3)(0, 1, 1)), 1))
print("cardinality of 3k not 6k", len(numbers3kNot6k), estimateDnfCardinality((ctypes.POINTER(ctypes.c_double) * 2)(sketch3k_ptr, sketch6k_ptr), 2, SKETCH_SIZE, (ctypes.POINTER(ctypes.c_ssize_t) * 1)((ctypes.c_ssize_t * 2)(1, -1)), 1))
print("cardinality of not 2k not 3k", len(numbersNot2kNot3k), estimateDnfCardinality((ctypes.POINTER(ctypes.c_double) * 2)(sketch2k_ptr, sketch3k_ptr), 2, SKETCH_SIZE, (ctypes.POINTER(ctypes.c_ssize_t) * 1)((ctypes.c_ssize_t * 2)(-1, -1)), 1))